...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkEmailStmt->rowCount() > 0) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO userdata (username, student_id, email, password) VALUES (?, ?, ?, ?)");
            $stmt->execute([$username, $student_id, $email, $password]);   
    ...
    <div class="container p-5 d-flex flex-column align-items-center">
      <h2 class="portal-title">MMU Talent Showcase Portal</h2>
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="mb-2">
             <label for="student_id"><i 
                class="fa fa-id-card"></i> Student ID</label>
